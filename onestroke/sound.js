...
window.OSSND = (function () {
  ...
  var SFX_FILES = {
    grab:    'sfx/選択3.mp3',   // ポートを掴んでベルトを引き始めた
    draw:    'sfx/スイッチ1.mp3',   // ドラッグ中に1マス伸びた（伸びるほど高くなる）
    undo:    'sfx/選択5.mp3',   // 引いてきた道を戻って1マス消えた
    deny:    'sfx/決定5.mp3',   // 壁・他のベルト・自分の跡に阻まれて伸びなかった
    link:    'sfx/選択4.mp3',   // つながって確定した
    cancel:  'sfx/決定4.mp3',   // つながらないまま離した
    erase:   'sfx/ページめくり1.mp3',   // 引いてあるベルトを消した
    craft:   'sfx/マウスクリック.mp3',   // 工場が完成品を1つ出した
    dup:     'sfx/マウスダブルクリック.mp3',   // 複製機が1つを2つに分けた
    deliver: 'sfx/スイッチ5.mp3',   // 納品口が1つ受け取った（納品が進むほど高くなる）
    goal:    'sfx/スイッチ6.mp3',   // 納品口が必要数を満たした
    clear:   'sfx/完了1.mp3',   // ステージクリア
    ui:      'sfx/確認2.mp3'    // ボタン・ステージ選択
  };
